...
const h1 = () => { doc.fontSize(22).font('Helvetica-Bold'); };
const h2 = () => { doc.fontSize(12).font('Helvetica-Bold'); };
const body = () => { doc.fontSize(10).font('Helvetica'); };
...
doc.text(' | ', { continued: true });
doc.text('github.com/sivaganesh1407', { link: 'https://github.com/sivaganesh1407', align: 'center' });
doc.moveDown(0.8);
...
doc.font('Helvetica-Bold').text('Full Stack Engineer', { continued: true });
doc.font('Helvetica').text(', Mad Mobile');
doc.font('Helvetica-Oblique').text('Nov 2025 – Present', { align: 'right' });
doc.font('Helvetica');
const madMobile = [
...
doc.font('Helvetica-Oblique').text('Feb 2025 – Oct 2025', { align: 'right' });
doc.font('Helvetica');
const corebridge = [
...
doc.font('Helvetica-Oblique').text('Feb 2024 – Dec 2024', { align: 'right' });
doc.font('Helvetica');
...
doc.font('Helvetica-Oblique').text('Jun 2021 – Jun 2022', { align: 'right' });
doc.font('Helvetica');
const infosys = [
...
doc.font('Helvetica-Oblique').text('Jun 2019 – May 2021', { align: 'right' });
doc.font('Helvetica');
const elder = [
...
doc.moveDown(0.5);
body();
bullet(); doc.font('Helvetica-Bold').text('AWS Certified DevOps Engineer – Professional', { continued: true });
doc.font('Helvetica').text(' (March 2025 – March 2027)');
bullet(); doc.font('Helvetica-Bold').text('AWS Certified Solutions Architect – Associate', { continued: true });
