        ...
        <div className="flex flex-col md:flex-row gap-10 items-start">
          ...
          <div className="flex-1">
            <p className="text-zinc-300 text-lg leading-relaxed mb-4">
              Java Full Stack Engineer with 6+ years of experience delivering enterprise web platforms using Java 17, Spring Boot, microservices, React, Docker, Kubernetes, and AWS.
            </p>
