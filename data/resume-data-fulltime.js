...
const resumeDataFulltime = {
  ...
  technicalSkillRows: [
    { category: 'Languages', detail: 'Java 17, TypeScript, JavaScript, SQL' },
    {
      category: 'Frontend',
      detail:
        'React.js, Angular, HTML5, CSS3, Redux, RxJS, SPA routing, responsive UI, form validation, Bootstrap, Material UI',
    },
    {
      category: 'Backend',
      detail:
        'Spring Boot, Spring MVC, Spring Security, Hibernate, JPA, REST APIs, Microservices, Swagger/OpenAPI, Maven, Gradle, OAuth2, JWT, RBAC, RESTful services, distributed systems',
    },
    {
      category: 'Cloud & DevOps',
      detail:
        'AWS (EC2, S3, RDS, Lambda, API Gateway, ECS), Docker, Kubernetes, Terraform, Jenkins, GitHub Actions, Bitbucket, CI/CD, Git, GitHub, DevSecOps, Infrastructure as Code (IaC)',
    },
    {
      category: 'Databases',
      detail:
        'PostgreSQL, MySQL, Oracle, MongoDB, Redis, DB2, SQL optimization, indexing, query tuning, stored procedures, transactions',
    },
    {
      category: 'Messaging & Integration',
      detail:
        'Apache Kafka, RabbitMQ, event-driven architecture, asynchronous processing, batch pipelines, near-real-time processing, REST integrations, API integrations',
    },
    {
      category: 'Testing & Monitoring',
      detail:
        'JUnit, Mockito, TestNG, Selenium, Cypress, Postman, Prometheus, Grafana, logging, monitoring, alerting, debugging, performance tuning',
    },
    {
      category: 'Developer Tools',
      detail:
        'IntelliJ IDEA, VS Code, Eclipse, Jira, Confluence, GitHub Copilot, Cursor AI, Claude AI, OpenAI APIs',
    },
    {
      category: 'Development Practices',
      detail:
        'Agile methodologies, Scrum, code reviews, CI/CD pipelines, production support, release coordination, defect triage, troubleshooting',
    },
  ],
  ...
  certifications: [
    ...
    { name: 'Oracle Certified Professional Java SE Developer (In Progress)' },
  ],
...
resumeDataFulltime.technicalSkills = resumeDataFulltime.technicalSkillRows
  .map((r) => `${r.category}: ${r.detail}`)
  .join(' | ');
resumeDataFulltime.summary = resumeDataFulltime.summaryParagraphs.join(' ');
