...
const PDF_URL = '/Java_FullStack_FullTime_Resume.pdf?v=25';
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Resume - Siva Ganesh Golla, Java Full Stack Engineer, 5+ years, Spring Boot, React, AWS" />
