  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Java Full Stack Engineer with 5+ years building scalable backend systems and modern web applications. Spring Boot, React, Microservices, AWS Certified." />
