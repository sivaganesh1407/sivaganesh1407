const links = [
  {
    label: 'Email',
    href: 'mailto:gsg1499@gmail.com',
    value: 'gsg1499@gmail.com',
  },
  {
    label: 'GitHub',
    href: 'https://github.com/sivaganesh1407',
    value: 'github.com/sivaganesh1407',
  },
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/ganeshg7/',
    value: 'linkedin.com/in/ganeshg7',
  },
];
  ...
  return (
    <section id="contact" className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl font-bold text-white mb-4">Contact <span className="text-accent-primary">Me</span></h2>
