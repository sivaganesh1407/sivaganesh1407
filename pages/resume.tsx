...
const PDF_URL = '/Java_FullStack_FullTime_Resume.pdf?v=24';
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Resume - Siva Ganesh Golla, Java Full Stack Engineer, 4+ to 5+ years, Spring Boot, React, AWS" />
